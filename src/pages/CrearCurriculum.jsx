...
const CrearCurriculum = () => {
  ...
  return (
    <Container className='mt-5 text-center'>
      ...
      <Row>
      <Col className='d-grid align-items-center justify-content-start fs-5'><div className='regresar' onClick={() => navigate(`/profesores/curriculum/${id}/otros`)}><FontAwesomeIcon icon={faAngleLeft} size='xl'/></div></Col>
        <Col xs={8} >
          <h1>¿Crear currículum?</h1>
            <Curriculum curriculum={curriculum}/>
          <div className='mb-5'>
            <Button variant='success' onClick={handleSubmit} size='lg' className='me-4'>Crear</Button>
            <Button variant='danger' size='lg' onClick={() => navigate('/profesores')}>Deshacer</Button>
          </div>
        </Col>
        <Col></Col>
      </Row>
