...
const Seccion4 = () => {
    ...
    useEffect(() =>{
        ...
        if(localStorage.getItem('data4')){
            setData4(JSON.parse(localStorage.getItem('data4')))
        }else{
            localStorage.setItem('data4', JSON.stringify(initialState))
        }
    ...
    const {campo1, campo2, campo3, campo4, campo5} = data4
  ...
  return (
    <Container className='mt-5'>
        ...
        <Row>
            <Col className='d-grid align-items-center justify-content-start fs-5'><div className='regresar' onClick={() => navigate(`/profesores/curriculum/${id}/seccion3`)}><FontAwesomeIcon icon={faAngleLeft} size='xl'/></div></Col>
            <Col xs={8}>
                <h1 className='text-center'>Seccion4</h1>
            ...
            <Col className='d-grid align-items-center justify-content-end fs-5'><div className='siguiente' onClick={() => navigate(`/profesores/curriculum/${id}/crear`)}><FontAwesomeIcon icon={faAngleRight} size='xl'/></div></Col>
        </Row>
    </Container>
  )
}
